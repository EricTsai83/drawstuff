...
const ICON_SWAP_DELAY_RATIO = 0.2;
        ...
        >
          ...
          >
            <span
              ...
              className={cn(
                "bg-primary group-hover/button:bg-primary/90 group-active/button:bg-primary/90 pointer-events-none absolute inset-0 rounded-full shadow-sm transition-[transform,background-color] ease-in-out motion-reduce:transition-none",
          ...
          <div
            aria-hidden="true"
            className="text-primary-foreground pointer-events-none absolute inset-0 grid place-items-center"
          >
            <span
              ...
              className={cn(
                ...
                open ? "opacity-0 blur-[2px]" : "opacity-100 blur-none",
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        onClick={handleClick}
        className={cn(
          "border-border bg-card text-card-foreground hover:bg-accent active:bg-accent/70 rounded-full shadow-sm transition-[transform,background-color] ease-out active:scale-[var(--floating-shortcut-press-scale)] disabled:opacity-40 motion-reduce:transform-none motion-reduce:transition-none",
