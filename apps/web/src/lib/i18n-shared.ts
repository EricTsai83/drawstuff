...
export const appTranslations: AppTranslations = {
  en: {
    ...
    "library.sync.checking-auth": "Checking Library sign-in...",
    "library.sync.anonymous": "Library is not saved",
    "library.sync.loading": "Loading Library...",
    "library.sync.saving": "Saving Library...",
    "library.sync.saved": "Library synced",
    "library.sync.error": "Library is not synced",
    "library.anonymous.saveNotice":
      "Sign in to keep your Library across sessions and devices.",
  ...
  "zh-TW": {
    ...
    "auth.and": "與",
    "auth.privacy": "隱私權政策",
    "library.sync.checking-auth": "正在確認 Library 登入狀態…",
    "library.sync.anonymous": "Library 尚未保存",
    "library.sync.loading": "正在載入 Library…",
    "library.sync.saving": "正在保存 Library…",
    "library.sync.saved": "Library 已同步",
    "library.sync.error": "Library 尚未同步",
    "library.anonymous.saveNotice":
      "登入後才能跨工作階段與裝置保存你的 Library。",
