/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 0d9369eaa03f8f11403c50e6bdafc9ac)
...
interface __BaseEnv_Env {
	...
	COLLAB_CRON_SECRET: string;
	COLLAB_OUTBOX_DRAIN_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COLLAB_ALLOWED_ORIGINS" | "COLLAB_JOIN_TOKEN_SECRET" | "COLLAB_CRON_SECRET" | "COLLAB_OUTBOX_DRAIN_URL">> {}
}
