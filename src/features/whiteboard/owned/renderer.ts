...
export class OwnedWhiteboardRenderer {
  ...
  private paintScene(
    ...
    for (const element of elements) {
      ...
      this.paintElement(context, element, assets);
      paintedElements += 1;
    }
    context.restore();
  ...
  private paintElement(
    ...
    context.strokeStyle = readElementString(element, "strokeColor", "#1e1e1e");
    context.fillStyle = readElementString(
      element,
      "backgroundColor",
      "transparent",
    );
    ...
    if (
      ...
      this.paintImage(context, element, assets);
    } else {
  ...
  private paintText(
    ...
    context.fillStyle = readElementString(element, "strokeColor", "#1e1e1e");
