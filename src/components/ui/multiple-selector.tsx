  ...
  (
    ...
    return (
      <Command
        ...
        shouldFilter={commandProps?.shouldFilter ?? !onSearch} // When onSearch is provided, we don't want to filter the options. You can still override it.
      ...
      >
                ...
                >
                  ...
                  <button
                    className={cn(
                      ...
                      [disabled, option.fixed].some(Boolean) && "hidden",
                    )}
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="bg-popover text-popover-foreground animate-in absolute top-1 z-10 mt-1 w-full rounded-md border shadow-md outline-none"
              onMouseLeave={() => {
