const defaultLang = { code: "en", label: "English" } as const;
const languages = [defaultLang, { code: "zh-TW", label: "繁體中文" }] as const;
...
function isAllowedLanguageCode(code: string): boolean {
