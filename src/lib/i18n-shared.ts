...
export const appTranslations: AppTranslations = {
  en: {
    ...
    "dashboard.filter.unpublished": "Unpublished",
    "search.placeholder":
  ...
  "zh-TW": {
    ...
    "dashboard.filter.published": "已發布",
    "dashboard.filter.unpublished": "未發布",
    ...
    "publish.badge": "已發布",
    "publish.menu.publish": "發布",
    "publish.menu.unpublish": "取消發布",
    "publish.menu.copyLink": "複製公開連結",
    "publish.menu.openLink": "打開公開連結",
    "publish.toast.published": "公開連結已建立。",
    "publish.toast.unpublished": "此場景已取消公開。",
